export const IPC_CHANNELS = {
    ...
    PRODUCTS_SYSTEM_SERVICE: 'products:systemService',
    ...
    LABELS_PREVIEW_PDF: 'labels:previewPdf',
    LABELS_HISTORY_LIST: 'labels:historyList',
    LABELS_HISTORY_GET: 'labels:historyGet',
    LABELS_HISTORY_DELETE: 'labels:historyDelete',
    LABELS_HISTORY_CLEAR: 'labels:historyClear',
    REPORTS_SUMMARY: 'reports:summary',
    REPORTS_EXPORT_PDF: 'reports:exportPdf',
    REPORTS_EXPORT_EXCEL: 'reports:exportExcel',
    SALES_LIST_BY_SESSION: 'sales:listBySession',
    SALES_GET_DETAIL: 'sales:getDetail',
    SALES_PARTIAL_RETURN: 'sales:partialReturn',
    SALES_VOID: 'sales:void',
    SALES_CREDIT_LIST: 'sales:creditList',
    SALES_CREDIT_PAY: 'sales:creditPay',
    SALES_CREDIT_PAYMENTS_BY_SESSION: 'sales:creditPaymentsBySession',

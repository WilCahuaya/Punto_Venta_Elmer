import { isCompactLabel, labelBarcodeMaxWidthMm, resolveLabelContentLayout } from './thermal-print';
...
export function labelSizeClassName(widthMm, heightMm) {
...
export function buildLabelCellCss(dims, rootSelector = '.label') {
...
export function buildLabelCellHtml(content, dims) {
...
export function buildSingleLabelDocumentHtml(content, dims) {
    const { widthMm, heightMm } = dims;
    return [
        '<!DOCTYPE html>',
        '<html>',
